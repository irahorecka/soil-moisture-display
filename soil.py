...
GPIO.add_event_detect(channel_20, GPIO.BOTH, bouncetime=100)  # let us know when the pin goes HIGH or LOW
GPIO.add_event_detect(channel_21, GPIO.BOTH, bouncetime=100)
GPIO.add_event_callback(channel_20, callback_20)  # assign function to GPIO PIN, Run function on change
